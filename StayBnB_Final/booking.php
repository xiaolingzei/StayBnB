<?php
/**
 * StayBnB - Booking Form with Payment Integration
 * REPLACE: booking.php
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['create_booking'])) {
    ...
    if (empty($checkin) || empty($checkout)) {
        ...
        $stmt->bind_param("siisssssiidds", 
            $booking_ref, $_SESSION['user_id'], $hotel_id, $user['fullname'], 
            $user['email'], $user['phone'], $checkin, $checkout, $guests, 
            $nights, $hotel['price_per_night'], $total_amount, $special_requests
        );
        ...
        if ($stmt->execute()) {
            ...
            redirect("payment.php?booking_id={$booking_id}", 'Booking created! Please complete payment.', 'success');
        } else {
            ...
            <div class="col-lg-8">
                <div class="booking-container">
                    ...
                    <form method="POST" action="booking.php?hotel_id=<?= $hotel_id ?>" id="bookingForm">
                        ...
                        <button type="submit" name="create_booking" class="btn btn-primary btn-book w-100">
            ...
            <div class="col-lg-4">
                <div class="price-summary">
                    ...
                    <div class="alert alert-info mb-0">
                        ...
                        <small>You will proceed to payment after booking confirmation</small>
                    </div>
