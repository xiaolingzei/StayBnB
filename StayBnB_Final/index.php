        ...
        <div class="container text-center">
            ...
            <div class="row mt-4">
                <div class="col-md-6 mx-auto">
                    <div class="card border-warning border-3" style="background: rgba(255,255,255,0.95);">
                        <div class="card-body text-center py-4">
                            <h3 class="text-warning mb-3">
                                <i class="fas fa-robot fa-2x"></i>
                            </h3>
                            <h4 class="text-dark">Try Our AI Travel Assistant!</h4>
                            <p class="text-muted mb-3">Get personalized hotel recommendations based on your preferences</p>
                            <a href="ai-assistant.php" class="btn btn-warning btn-lg">
                    <i class="fas fa-magic me-2"></i>Talk to AI Assistant
                        </a>
                </div>
            </div>
      </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><a href="report-issue.php" class="text-white-50 text-decoration-none">Report an Issue</a></li>
