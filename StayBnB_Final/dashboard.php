<?php
/**
 * StayBnB - User Dashboard
 * Copy this to: dashboard.php (REPLACE dashboard.html)
 */
        ...
        <div class="row g-4 mb-5">
            ...
            <div class="col-md-3">
                <div class="stat-card">
                    ...
                    <h3 class="mb-1">₱<?= number_format($stats['total_spent']) ?></h3>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ...
                <input type="hidden" id="bookingId" value="<?= $bookings->num_rows > 0 ? $bookings->fetch_assoc()['booking_id'] : 0 ?>">
...
<script>
// Show rating modal after 10 seconds on dashboard
setTimeout(() => {
